...
The app provides quote rating, favorites, search, notifications, and complete light/dark mode support, all wrapped in a fast and resilient user experience.

---

## ✨ Features

- **Daily Quotes** — Random quotes fetched from the ZenQuotes API with retries and built-in fallback content.  
...
- **Smooth Navigation** — Built with GetX for fast, reliable routing.
...
Feel free to open issues, create pull requests, or suggest improvements to help the project evolve.
